...
function generatePointsAndLines(squareSizes, boardCenter, pointSize) {
  ...
  squareSizes.forEach((size, index) => {
    ...
    const positions = [
      {
        x: offset - pointSize / 2 + lineThickness / 2,
        y: offset - pointSize / 2 + lineThickness / 2,
      }, // Upper left corner
      {
        x: boardCenter - pointSize / 2 - lineThickness / 2,
        y: offset - pointSize / 2 + lineThickness / 2,
      }, // Upper middle corner
      {
        x: boardCenter + half - pointSize / 2 - lineThickness / 2,
        y: offset - pointSize / 2 + lineThickness / 2,
      }, // Upper right corner
      {
        x: offset - pointSize / 2 + lineThickness / 2,
        y: boardCenter - pointSize / 2,
      }, // Middle left point
      {
        x: boardCenter + half - pointSize / 2 - lineThickness / 2,
        y: boardCenter - pointSize / 2,
      ...
      {
        x: offset - pointSize / 2 + lineThickness / 2,
        y: boardCenter + half - pointSize / 2 - lineThickness / 2,
      }, // Lower left corner
      {
        x: boardCenter - pointSize / 2 + lineThickness / 2,
        y: boardCenter + half - pointSize / 2 - lineThickness / 2,
